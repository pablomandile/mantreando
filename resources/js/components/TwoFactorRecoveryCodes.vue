...
<template>
    <Card class="w-full">
        <CardHeader>
            ...
            <CardDescription>
                Los códigos de recuperación te permiten volver a entrar si
                perdés tu dispositivo 2FA. Guardalos en un lugar seguro.
            </CardDescription>
        </CardHeader>
        <CardContent>
            <div
            ...
            >
                ...
                <div v-else class="mt-3 space-y-3">
                    ...
                    <p class="text-xs text-muted-foreground select-none">
                        Cada código se puede usar una sola vez para entrar a tu
                        cuenta y se elimina al usarse. Si necesitás más, tocá
